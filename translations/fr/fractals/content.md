...
{.reveal(when="blank-8")} Cela signifie que, encore une fois, nous avons une série géométrique, mais dans ce cas, elle [[ne converge pas|converge vers 0|n'a pas de premier terme]]. _{span.reveal(when="blank-9")} Cela signifie que le périmètre du flocon de neige de Koch est en fait __infiniment long__!_
