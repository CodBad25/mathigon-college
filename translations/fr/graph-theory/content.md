...
> id: euler-2
    ...
    x-slideshow
      ...
      .legend(slot="legend") Le graphe le plus simple est constitué d'un seul sommet. On peut facilement vérifier que l'équation d'Euler fonctionne.
      .legend(slot="legend") Ajoutons un nouveau sommet à notre graphe. Nous devons aussi ajouter une arête, et l'équation d'Euler fonctionne toujours.
      .legend(slot="legend") Si nous voulons ajouter un troisième sommet au graphe, nous avons deux possibilités. Nous pourrions créer un petit triangle : cela ajoute un sommet, une face et deux arêtes, donc l'équation d'Euler fonctionne toujours.
      .legend(slot="legend") Sinon, nous pourrions simplement prolonger la ligne d'un sommet : cela ajoute un sommet et une arête, et l'équation d'Euler fonctionne.
      .legend(slot="legend") Continuons : si nous créons maintenant un quadrilatère, nous ajoutons un sommet, deux arêtes et une face. L'équation d'Euler fonctionne toujours.
